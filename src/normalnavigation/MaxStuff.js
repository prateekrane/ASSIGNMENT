  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.lwrctn}>
        ...
        >
          <View>
            <Text style={{ fontSize: 35, fontWeight: "800" }}>50% OFF</Text>
          </View>
          <View>
            <Text style={{ fontSize: 25, fontWeight: "800" }}>MAX STUFF!!</Text>
          </View>
          <View style={{ marginTop: deviceWidth / 20 }}>
            <Text style={{ fontSize: 20, fontWeight: "400" }}>
              On buying 1 large pack of combo Noodels this CODE="HRUOP" give you
              direct 50% OFF on your total price.
            </Text>
          </View>
