  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.lwrctn}>
        ...
        >
          <View>
            <Text style={{ fontSize: 35, fontWeight: "800" }}>75% OFF</Text>
          </View>
          <View>
            <Text style={{ fontSize: 25, fontWeight: "800" }}>HYP MAX!!</Text>
          </View>
          <View style={{ marginTop: deviceWidth / 20 }}>
            <Text style={{ fontSize: 20, fontWeight: "400" }}>
              On buying 1 large pack of combo friedrice this CODE="HRUOP" give
              you direct 75% OFF on your total price.
            </Text>
          </View>
