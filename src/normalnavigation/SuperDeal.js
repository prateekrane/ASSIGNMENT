  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.lwrctn}>
        ...
        >
          <View>
            <Text style={{ fontSize: 35, fontWeight: "800" }}>10% OFF</Text>
          </View>
          <View>
          ...
          <View style={{ marginTop: deviceWidth / 20 }}>
            <Text style={{ fontSize: 20, fontWeight: "400" }}>
              On buying 1 large pack of combo burger this CODE="HRUOP" give you
              direct 10% OFF on your total price.
            </Text>
          </View>
