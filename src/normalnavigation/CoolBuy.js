    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.lwrctn}>
        ...
        >
          ...
          <View>
            <Text style={{ fontSize: 25, fontWeight: "800" }}>COOL BUY</Text>
          </View>
          <View style={{ marginTop: deviceWidth / 20 }}>
            <Text style={{ fontSize: 20, fontWeight: "400" }}>
              On buying 1 large pack of combo sandwitch this CODE="HRUOP" give
              you direct 30% OFF on your total price.
            </Text>
          </View>
